...
_facewear append ["G_Aviator", "G_Spectacles", "G_Spectacles_Tinted", "G_Squares", "G_Squares_Tinted", "gm_ge_facewear_glacierglasses"];
_facewear append ["gm_gc_army_facewear_dustglasses"];
