...
_traitorUniforms append ["CUP_U_B_USMC_FROG1_DMARPAT"];
_traitorVests append ["CUP_V_B_Eagle_SPC_Empty"];
_traitorHats append ["CUP_H_USMC_BOONIE_2_DES"];

_officerUniforms append ["CUP_U_B_USMC_FROG1_DMARPAT"];
...
_SNIhats append ["CUP_H_USMC_BOONIE_2_DES"];
