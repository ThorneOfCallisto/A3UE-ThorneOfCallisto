_sfhelmets pushBack "lxWS_H_bmask_camo02";
_sfvests pushBack "V_lxWS_TacVestIR_oli";

_elitehelmets pushBack "lxWS_H_bmask_camo02";
_elitevests pushBack "V_lxWS_TacVestIR_oli";
