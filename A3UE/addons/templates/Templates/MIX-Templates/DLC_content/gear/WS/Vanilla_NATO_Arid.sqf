...
_militiaHvests pushBack "V_lxWS_PlateCarrier2_desert";
_militiaGLvests pushBack "V_lxWS_PlateCarrier2_desert";
_militiabackpacks append ["B_AssaultPack_desert_lxWS"];
_militiaATBackpacks append ["B_Kitbag_desert_lxWS"];
_militiahelmets append ["lxWS_H_Booniehat_desert", "lxWS_H_MilCap_desert","lxWS_H_PASGT_facewear_olive_F","lxWS_H_PASGT_facewear_black_F"];
_militiaSLhats pushBack "lxWS_H_MilCap_desert";
_militiaSNIhats pushBack "lxWS_H_Booniehat_desert";
