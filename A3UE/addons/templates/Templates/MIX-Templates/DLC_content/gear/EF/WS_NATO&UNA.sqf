...
_militaryhelmets append ["EF_H_Protecta",  "EF_H_HelmetB_light_black_slick", "EF_H_HelmetB_light_tna_slick", "EF_H_MCH", "EF_H_MCH_BasicNet_Black", "EF_H_MCH_BasicNet_Olive", "EF_H_MCH_BasicNet_Wdl"];
_militaryHvests append ["EF_V_CCR_Support_Olive", "EF_V_CCR_TL_Olive", "EF_V_CCR_Support_Black", "EF_V_CCR_TL_Black","EF_V_AAV_Support_Olive", "EF_V_AAV_TL_Olive", "EF_V_AAV_TL_Black", "EF_V_AAV_Support_Black"];
_militaryvests append ["EF_V_CCR_Rifleman_Olive", "EF_V_CCR_Scout_Olive", "EF_V_CCR_Rifleman_Black", "EF_V_CCR_Scout_Black", "EF_V_AAV_Olive", "EF_V_AAV_Black"];
_militaryGLvests append ["EF_V_AAV_Support_Olive", "EF_V_AAV_Support_Black"];

/////////
_militiaNVGs append ["EF_LPNVG_T", "EF_LPNVG"];
_militaryhelmets pushBack "EF_H_HelmetCrew_White";
_militiabackpacks pushBack "EF_B_RaiderPack_coy";
_militiaHvests append ["EF_V_AAV_Support_Coy", "EF_V_CCR_Support_Coy"];
_militiavests append ["EF_V_CCR_Support_Coy"];
_militiaGLvests pushBack "EF_V_AAV_Support_Coy";