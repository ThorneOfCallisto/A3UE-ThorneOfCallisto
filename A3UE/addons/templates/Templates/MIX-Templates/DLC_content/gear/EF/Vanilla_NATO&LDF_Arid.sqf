...
_militiabackpacks pushBack "EF_B_RaiderPack_olive";
_militiaHvests pushBack "EF_V_AAV_Support_Olive";
_militiavests pushBack "EF_V_AAV_Olive";
_militiaGLvests pushBack "EF_V_AAV_Support_Olive";
_militiahelmets append ["EF_H_HelmetB_light_black_slick","EF_H_HelmetB_light_wdl_slick","EF_H_Protecta"];
