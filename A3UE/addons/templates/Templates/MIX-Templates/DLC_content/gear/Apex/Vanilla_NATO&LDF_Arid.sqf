...
_sfvests pushBack "V_PlateCarrier1_rgr_noflag_F";
...
_elitevests pushBack "V_PlateCarrier1_rgr_noflag_F";
_eliteHvests pushBack "V_PlateCarrier2_rgr_noflag_F";
...
_militaryHvests pushBack "V_PlateCarrier2_rgr_noflag_F";
_militaryGLvests pushBack "V_PlateCarrier2_rgr_noflag_F";



_militiavests append ["V_PlateCarrier1_rgr_noflag_F","V_PlateCarrier2_rgr_noflag_F","V_TacChestrig_grn_F","V_TacChestrig_oli_F"];

_pilothelmets append ["H_MilCap_gen_F","H_Beret_gen_F"];
_policevests pushBack "V_TacVest_gen_F";
_policeuniforms append ["U_B_GEN_Soldier_F", "U_B_GEN_Commander_F"];
