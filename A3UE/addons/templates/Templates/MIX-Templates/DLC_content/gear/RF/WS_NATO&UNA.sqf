...
_militiahelmets append ["H_HelmetB_plain_sb_khaki_RF","H_HelmetHeavy_White_RF","H_HelmetHeavy_Simple_White_RF","H_HelmetHeavy_VisorUp_White_RF"];
_militiabackpacks append ["B_DuffleBag_Blue_RF"];
