...
_militiabackpacks append ["B_DuffleBag_Olive_NoLogo_RF","I_CommandoMortar_weapon_RF"];
_militiahelmets append ["H_HelmetIA_sb_digital_RF","H_HelmetHeavy_Olive_RF","H_HelmetHeavy_Simple_Olive_RF","H_HelmetHeavy_VisorUp_Olive_RF"];
