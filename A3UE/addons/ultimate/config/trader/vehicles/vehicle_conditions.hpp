#define VEHICLE_CONDITION_AA (["seaports_2"] call A3U_fnc_hasRequirements || ["resources_3"] call A3U_fnc_hasRequirements) && ["factories_3"] call A3U_fnc_hasRequirements

#define VEHICLE_CONDITION_APC (["seaports_2"] call A3U_fnc_hasRequirements || ["resources_3"] call A3U_fnc_hasRequirements) && ["factories_3"] call A3U_fnc_hasRequirements

#define VEHICLE_CONDITION_ARMEDCAR ["resources_1"] call A3U_fnc_hasRequirements && ["factories_3"] call A3U_fnc_hasRequirements
